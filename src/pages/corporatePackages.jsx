...
const packageDetails = {
  ...
  idealFor: 'Businesses, schools, government projects, hotels, hospitals, and private sector buildings.',
  includes: [
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 md:p-6">
                      <div className="max-w-[2400px] mx-auto">
                        <h3 className="text-xl md:text-2xl font-bold text-white mb-2">Corporate Package</h3>
                ...
                <div className="relative z-10 flex flex-col items-start h-full px-8 lg:px-11 xl:px-16 pt-8">
                  ...
                  <div className="mb-8">
                    <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                      For Companies, Offices, Schools, and Institutions
                    </h2>
                  ...
                  <div className="w-full mb-10">
                    ...
                    {packageDetails.optional && packageDetails.optional.length > 0 && (
                      <div className="mt-8">
                        <h3 className="text-xl lg:text-2xl font-bold text-white mb-3">Optional Add-Ons</h3>
                        <ul className="space-y-3 max-w-4xl">
                          {packageDetails.optional.map((item, i) => (
