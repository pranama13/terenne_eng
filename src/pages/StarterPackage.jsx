...
import packageImage from '../assert/Packages/coper.png'; // Replace with starter package image
...
const packageDetails = {
  ...
  price: '$500',
  idealFor: 'Small house builders, basic 1-storey buildings, or those with tight budgets.',
  includes: [
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 md:p-6">
                      <div className="max-w-[2400px] mx-auto">
                        <h3 className="text-xl md:text-2xl font-bold text-white mb-2">Starter Package</h3>
                ...
                <div className="relative z-10 flex flex-col items-start h-full px-8 lg:px-11 xl:px-16 pt-8">
                  ...
                  <div className="mb-8">
                    <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                      For First-Time Builders <span className="text-primary-300">or Small Homes</span>
                    </h2>
